...
<head>
    ...
    <title>Yêu thích || Shop Của Cường</title>
...
<div class="wrapper">
                ...
                <div class="row">
                    <div class="menumenu__container clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                            <div class="logo">
                                <a href="{{route('index')}}"><img src="{{asset('images/logo/4.png')}}"
                                                                  alt="logo images"></a>
                            </div>
                        </div>
                            ...
                            <div class="header__right">
                                ...
                                <div class="htc__shopping__cart">
                                    ...
                                    <a href="{{route('index.cart')}}"><span
                                            class="htc__qua">{{session()->get('cart')->totalQty}}</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="ht__bradcaump__area"
         style="background: rgba(0, 0, 0, 0) url({{asset('storage/anh/backgroud.jpg')}}) no-repeat scroll center center / cover ;">
                                        ...
                                        @foreach($wishlist as $key => $value)
                                            <tr>
                                                <td class="product-remove"><a
                                                        href="{{route('remove.wishlist',$value['item']->id)}}">×</a>
                                                </td>
                                                <td class="product-thumbnail"><a href="#"><img
                                                            src="{{$value['item']->HinhAnh}}" alt=""/></a></td>
                                                <td class="product-name"><a href="#">{{$value['item']->TenSp}}</a>
                                                </td>
                                                <td class="product-price"><span
                                                        class="amount">{{number_format($value['item']->GiaTien)}}</span>
                                                </td>
                                                <td class="product-stock-status"><span
                                                        class="wishlist-in-stock">{{$value['item']->TrangThai}}</span>
                                                </td>
                                                <td class="product-add-to-cart"><a
                                                        href="{{route('add.cart',$value['item']->id)}}"> Mua </a></td>
                                            </tr>
                                        @endforeach
                                        @if(session()->get('wishList')->product == [])
                                            <tr>
    ...
    <div class="htc__banner__area">
        <ul class="banner__list owl-carousel owl-theme clearfix">
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/1.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/2.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/3.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/4.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/5.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/6.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/1.jpg')}}" alt="banner images"></a>
            </li>
            <li><a href="product-details.html"><img src="{{asset('images/banner/bn-3/2.jpg')}}" alt="banner images"></a>
