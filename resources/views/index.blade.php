...
<head>
    ...
    <title>Shop Của Cường</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/favicon.icon')}}">
    <link rel="apple-touch-icon" href="apple-touch-icon.png">
    <link rel="" href="{{asset('fonts')}}">
                ...
                <div class="row">
                    <div class="menumenu__container clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                            <div class="logo">
                                <a href="{{route('index')}}"><img src="images/logo/4.png" alt="logo images"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                            <div class="header__right">
                                ...
                                <div class="htc__shopping__cart">
                                    <a class="cart__menu" href="{{route('index.cart')}}"><i
                                            class="icon-handbag icons"></i></a>
                                    <a href="{{route('index.cart')}}"><span>
                                            @if(Session::has('cart'))
                                                <a href="{{route('index.cart')}}"><span
                                                        class="htc__qua">{{session('cart')->totalQty}}</span></a>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items__center">
                        <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                            <div class="slide">
                                <div class="slider__inner">
                                    ...
                                    <h1>NICE CHAIR</h1>
                                    <div class="cr__btn">
                                        <a href="{{route('index.cart')}}">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                            <div class="slide__thumb">
                                <img src="{{asset('storage/anh/anh_1.jpg')}}" alt="slider images">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single__slide animation__style01 slider__fixed--height">
                <div class="container">
                    <div class="row align-items__center">
                        ...
                        <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                            <div class="slide__thumb">
                                <img src="{{asset('storage/anh/anh_2.jpg')}}" alt="slider images">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="category">
                                        <div class="ht__cat__thumb">
                                            <a href="product-details.html">
                                                <img src="{{asset($value->HinhAnh)}}" alt="product images">
                                            </a>
                                        </div>
                                        <div class="fr__hover__info">
                                            <ul class="product__action">
                                                <li><a href="{{route('add.wishlist',$value->id)}}"><i
                                                            class="icon-heart icons"></i></a></li>
                                                <li><a href="{{route('add.cart',$value->id)}}"><i
                                        ...
                                        <div class="fr__product__inner">
                                            <h7><a href="product-details.html">{{$value->TenSp}}</a></h7>
                                            <ul class="fr__pro__prize">
                                                <li>{{number_format($value->GiaTien)}} VND</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                    <div class="prize__inner">
                        <div class="prize__thumb">
                            <img src="{{asset('storage/anh/backgroud.jpg')}}" alt="banner images">
                        </div>
                        ...
                        @for($i =0; $i<4; $i++)
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product-details.html">
                                            <img src="{{$product[$i]->HinhAnh}}" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                                            <li><a href="{{route('add.wishlist',$product[$i]->id)}}"><i class="icon-heart icons"></i></a>
                                            </li>

                                            <li><a href="{{route('add.cart',$product[$i]->id)}}"><i class="icon-handbag icons"></i></a>
                                            </li>
                                    ...
                                    <div class="fr__product__inner">
                                        <h4><a href="product-details.html">{{$product[$i]->TenSp}}</a></h4>
                                        <ul class="fr__pro__prize">
                                            <li>{{$product[$i]->GiaTien}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 single__tes">
                                <div class="testimonial">
                                    <div class="testimonial__thumb">
                                        <img src="{{$value->HinhAnh}}" alt="testimonial images">
                                    </div>
                                    <div class="testimonial__details">
                                        <h4><a href="#">{{$value->TenTraSua}}</a></h4>
                                        <p>I’m up to something. Stay focused. The weather is amazing, walk with me
                                            through the
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="htc__best__product">
                                <div class="htc__best__pro__thumb">
                                    <a href="product-details.html">
                                        <img src="{{$product[$i]->HinhAnh}}" alt="small product">
                                    </a>
                                </div>
                                <div class="htc__best__product__details">
                                    ...
                                    <div class="best__product__action">
                                        <ul class="product__action--dft">
                                            <li><a href="{{route('index.cart')}}"><i class="icon-heart icons"></i></a>
                                            </li>
                                            <li><a href="{{route('index.cart')}}"><i class="icon-handbag icons"></i></a>
                                            </li>
                                            <li><a href="{{route('index.cart')}}"><i class="icon-shuffle icons"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
